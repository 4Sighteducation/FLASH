...
const GlowWrapper: React.FC<GlowWrapperProps> = ({ 
  ...
  const shadowRadius = intensity === 'high' ? 28 : intensity === 'medium' ? 18 : 10;
  const shadowOpacity = intensity === 'high' ? 0.95 : intensity === 'medium' ? 0.8 : 0.6;
...
export const StandbyIcon: React.FC<LevelIconProps> = ({ size = 80, animated = false }) => {
  ...
  return (
    <GlowWrapper glowColor={COLORS.pink} intensity="low" size={size} animated={animated}>
...
export const WakingUpIcon: React.FC<LevelIconProps> = ({ size = 80, animated = false }) => {
  ...
  return (
    <GlowWrapper glowColor={COLORS.cyan} intensity="low" size={size} animated={animated}>
      <Svg width={size} height={size} viewBox="0 0 100 100">
...
export const BootingIcon: React.FC<LevelIconProps> = ({ size = 80, animated = false }) => {
  ...
  return (
    <GlowWrapper glowColor={COLORS.cyan} intensity="medium" size={size} animated={animated}>
      <Svg width={size} height={size} viewBox="0 0 100 100">
        <Defs>
