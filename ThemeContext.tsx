...
const cyberDark: Theme = {
  ...
  effects: {
    ...
    shadow: {
      small: createShadow('#00F5FF', 0.15, 4, 2),
      medium: createShadow('#00F5FF', 0.2, 8, 4),
      large: createShadow('#00F5FF', 0.25, 16, 8),
      glow: createShadow('#00F5FF', 0.4, 20, 10, 0),
    },
...
const cyberLight: Theme = {
  ...
  effects: {
    ...cyberDark.effects,
    shadow: {
      small: createShadow('#000000', 0.05, 4, 2),
      medium: createShadow('#000000', 0.08, 8, 4),
      large: createShadow('#000000', 0.1, 16, 8),
      glow: createShadow('#00B4D8', 0.2, 12, 6, 0),
    },
  },
};
...
const pulseDark: Theme = {
  ...
  effects: {
    ...
    shadow: {
      small: createShadow('#FF6B35', 0.15, 6, 3),
      medium: createShadow('#FF6B35', 0.2, 12, 6),
      large: createShadow('#FF6B35', 0.25, 20, 10),
      glow: createShadow('#FF6B35', 0.4, 25, 12, 0),
    },
    ...
    animations: {
      pulseEnabled: true,
      pulseScale: 1.03,        // Slightly more than Cyber - "breathing"
      pulseDuration: 3000,     // Slower, organic feel
      glowEnabled: true,
      glowIntensity: 0.7,
      floatEnabled: true,
      floatDistance: 4,
...
const pulseLight: Theme = {
  ...
  effects: {
    ...pulseDark.effects,
    shadow: {
      small: createShadow('#000000', 0.05, 6, 3),
      medium: createShadow('#000000', 0.08, 12, 6),
      large: createShadow('#000000', 0.1, 20, 10),
      glow: createShadow('#E55A2B', 0.15, 15, 8, 0),
    },
  },
};
...
const auroraDark: Theme = {
  ...
  effects: {
    ...
    shadow: {
      small: createShadow('#22D3EE', 0.12, 8, 4),
      medium: createShadow('#22D3EE', 0.18, 16, 8),
      large: createShadow('#22D3EE', 0.22, 24, 12),
      glow: createShadow('#22D3EE', 0.35, 30, 15, 0),
    },
    ...
    animations: {
      pulseEnabled: true,
      pulseScale: 1.02,
      pulseDuration: 4000,     // Slow, ethereal
      glowEnabled: true,
      glowIntensity: 0.8,
      floatEnabled: true,
      floatDistance: 6,
...
const auroraLight: Theme = {
  ...
  effects: {
    ...auroraDark.effects,
    shadow: {
      small: createShadow('#000000', 0.05, 8, 4),
      medium: createShadow('#000000', 0.08, 16, 8),
      large: createShadow('#000000', 0.1, 24, 12),
      glow: createShadow('#0891B2', 0.12, 20, 10, 0),
    },
  },
};
...
const singularityDark: Theme = {
  ...
  effects: {
    ...
    shadow: {
      small: createShadow('#FBBF24', 0.2, 8, 4),
      medium: createShadow('#FBBF24', 0.28, 16, 8),
      large: createShadow('#FBBF24', 0.35, 28, 14),
      glow: createShadow('#FBBF24', 0.5, 40, 20, 0),
    },
    ...
    animations: {
      ...
      pulseDuration: 3000,
      glowEnabled: true,
      glowIntensity: 1.0,      // Maximum glow for ultimate theme
      floatEnabled: true,
      floatDistance: 8,
    },
  },
...
const singularityLight: Theme = {
  ...
  effects: {
    ...
    shadow: {
      small: createShadow('#000000', 0.08, 8, 4),
      medium: createShadow('#000000', 0.1, 16, 8),
      large: createShadow('#000000', 0.12, 28, 14),
      glow: createShadow('#D97706', 0.2, 25, 12, 0),
    },
  },
};
